...
-- Changeset db/changelog/changes/0.1.0/11.yaml::con-change-11-01::limit
ALTER TABLE com_entorn_app ADD jdk_version VARCHAR2(10);

ALTER TABLE com_entorn_app ADD revisio VARCHAR2(64);

-- Changeset db/changelog/changes/0.1.0/1608.yaml::est-change-1608-01::limit
...
-- Changeset db/changelog/changes/0.1.0/30.yaml::salut-change-30-2::Limit
...
-- Changeset db/changelog/changes/0.1.0/30.yaml::salut-change-30-3::Limit
...
-- Changeset db/changelog/changes/0.1.0/30.yaml::salut-change-30-4::Limit
...
-- Changeset db/changelog/changes/0.1.0/30.yaml::salut-change-30-5::Limit
...
-- Changeset db/changelog/changes/0.1.0/33.yaml::con-change-33-01::limit
...
-- Changeset db/changelog/changes/0.1.0/33.yaml::con-change-33-02::limit
ALTER TABLE com_parametre ADD CONSTRAINT com_parametre_codi_uk UNIQUE (codi);

-- Changeset db/changelog/changes/0.1.0/8.yaml::con-change-08-01::limit
...
-- Changeset db/changelog/changes/0.1.0/8.yaml::con-change-08-02::limit
...
-- Changeset db/changelog/changes/0.1.0/8.yaml::con-change-08-03::limit
ALTER TABLE com_app_context ADD CONSTRAINT com_app_ctx_appcodi_uk UNIQUE (entorn_app_id, codi);

-- Changeset db/changelog/changes/0.1.0/8.yaml::con-change-08-04::limit
...
-- Changeset db/changelog/changes/0.1.0/est_32.yaml::est-change-32-1::limit
...
-- Changeset db/changelog/changes/0.1.0/est_32.yaml::est-change-32-2::limit
...
-- Changeset db/changelog/changes/0.1.0/est_32.yaml::est-change-32-3::limit
...
-- Changeset db/changelog/changes/0.1.0/est_32.yaml::est-change-32-4::limit
