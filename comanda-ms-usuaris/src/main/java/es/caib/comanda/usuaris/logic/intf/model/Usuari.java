...
@ResourceConfig(
	...
	artifacts = {
			...
			@ResourceArtifact(type = ResourceArtifactType.PERSPECTIVE, code = Usuari.PERSPECTIVE_DARRERA_CONNEXIO),
	}
)
public class Usuari extends BaseResource<Long> {
	...
	public static final String PERSPECTIVE_DARRERA_CONNEXIO = "DARRERA_CONNEXIO";
    ...
    private LocalDateTime darreraConnexio;
}
