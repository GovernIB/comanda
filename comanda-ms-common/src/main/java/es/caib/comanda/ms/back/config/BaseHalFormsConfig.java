...
public abstract class BaseHalFormsConfig {
	...
	private Set<MutableResourceController> resourceControllers;
	...
	// Metode halFormsConfiguration generic. Aquesta versio empra MutableResourceController en lloc de ReadonlyResourceController
//	@Bean
//	HalFormsConfiguration halFormsConfiguration() {
//		Set<Class<MutableResourceController>> resourceControllerClasses = null;
//		if (resourceControllers != null) {
//			resourceControllerClasses = resourceControllers.stream().
//				map(rc -> (Class<MutableResourceController>) rc.getClass()).
...
//	}
	...
	private Link getFindLinkWithSelfRel(
		...
		if (artifact == null) {
			...
			return linkTo(methodOn(MutableResourceControllerClass).artifactReportFieldOptionsFind(
				artifact.code(),
				resourceFieldName,
				null,
				null,
			...
			return linkTo(methodOn(MutableResourceControllerClass).artifactFilterFieldOptionsFind(
				artifact.code(),
				resourceFieldName,
				null,
				null,
