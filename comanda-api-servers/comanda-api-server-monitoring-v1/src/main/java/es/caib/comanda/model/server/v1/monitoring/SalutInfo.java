...
import es.caib.comanda.model.server.v1.monitoring.EstatSalut;
import es.caib.comanda.model.server.v1.monitoring.InformacioSistema;
import es.caib.comanda.model.server.v1.monitoring.IntegracioSalut;
import es.caib.comanda.model.server.v1.monitoring.MissatgeSalut;
import es.caib.comanda.model.server.v1.monitoring.SubsistemaSalut;
