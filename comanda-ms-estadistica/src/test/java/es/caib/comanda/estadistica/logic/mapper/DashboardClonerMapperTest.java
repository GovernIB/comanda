...
class DashboardClonerMapperTest {
    ...
    void cloneTitol_clonaPropietatsCorrectament() {
        ...
        original.setMostrarVora(true);
        original.setColorVora("#CCCCCC");
        original.setAmpleVora(2);
        ...
        assertThat(clone.getMostrarVora()).isTrue();
        assertThat(clone.getColorVora()).isEqualTo("#CCCCCC");
        assertThat(clone.getAmpleVora()).isEqualTo(2);
