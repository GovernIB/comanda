...
/**
 * Configuració de persistència per a l'ús del mòdul d'estadístiques.
 * Aquesta classe hereta el comportament configurat en BasePersistenceConfig, afegint configuracions específiques per a estadístiques.
 *
