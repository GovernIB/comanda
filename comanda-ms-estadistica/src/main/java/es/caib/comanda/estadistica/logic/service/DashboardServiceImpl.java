        ...
        private AtributsVisualsTitol resolveAtributsVisualsTitol(
            ...
            AtributsVisualsTitol atributsVisuals = Boolean.TRUE.equals(titol.getPersonalitzat())
                    ? AtributsVisualsTitol.builder()
                            ...
                            .posicioSubtitol(titol.getPosicioSubtitol())
                            .separacioSubtitol(titol.getSeparacioSubtitol())
                            .mostrarVoraTop(titol.getMostrarVoraTop())
                            .colorVoraTop(titol.getColorVoraTop())
                            .ampleVoraTop(titol.getAmpleVoraTop())
                            .mostrarVoraRight(titol.getMostrarVoraRight())
                            .colorVoraRight(titol.getColorVoraRight())
                            .ampleVoraRight(titol.getAmpleVoraRight())
                            .mostrarVoraBottom(titol.getMostrarVoraBottom())
                            .colorVoraBottom(titol.getColorVoraBottom())
                            .ampleVoraBottom(titol.getAmpleVoraBottom())
                            .mostrarVoraLeft(titol.getMostrarVoraLeft())
                            .colorVoraLeft(titol.getColorVoraLeft())
                            .ampleVoraLeft(titol.getAmpleVoraLeft())
                            .build()
