...
public class IntegracioPeticions {
    ...
    @Schema(description = "Endpoint concret associat a aquestes mètriques", example = "/api/v1/notificacions")
    @Size(max = 255)
    private String endpoint;

    @Schema(description = "Mètriques per entorn (clau = codi d'entorn)")
    @Builder.Default
