...
@ResourceConfig(
		...
		artifacts = {
                ...
                @ResourceArtifact(type = ResourceArtifactType.REPORT, code = Salut.SALUT_REPORT_ESTATS_HISTORICS, formClass =  SalutInformeHistoricsParams.class),
...
public class Salut extends BaseResource<Long> {
    ...
    public final static String SALUT_REPORT_ESTATS_HISTORICS = "estats_historics";
