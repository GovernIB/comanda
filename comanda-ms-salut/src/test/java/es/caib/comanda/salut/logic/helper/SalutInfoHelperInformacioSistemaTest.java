...
class SalutInfoHelperInformacioSistemaTest {
    ...
    @Test
    void crearSalut_quanHiHaInformacioSistema_persistixElsDetallsDerivats() throws Exception {
        Long entornAppId = 9L;
        ...
        assertThat(d.getCodi()).isNotBlank();
        assertThat(d.getNom()).isNotBlank();
        assertThat(d.getValor()).isNotBlank();
    }
}
