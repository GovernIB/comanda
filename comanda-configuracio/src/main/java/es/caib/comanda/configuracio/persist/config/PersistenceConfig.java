...
import es.caib.comanda.configuracio.persist.repository.BaseRepositoryImpl;
...
@EnableJpaRepositories(
		basePackages = { BaseConfig.BASE_PACKAGE + ".persist" },
...
public class PersistenceConfig {
	...
	protected String getPersistenceUnitName() {
		return BaseConfig.APP_NAME + "PU";
	}

	protected String getEntityPackages() {
		return BaseConfig.BASE_PACKAGE + ".persist";
	}
