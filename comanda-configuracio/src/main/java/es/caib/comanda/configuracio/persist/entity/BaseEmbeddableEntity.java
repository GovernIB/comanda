...
public abstract class BaseEmbeddableEntity<R extends Resource<PK>, PK extends Serializable> implements AuditableEntity, Persistable<PK> {

	@Embedded
	protected R embedded;
