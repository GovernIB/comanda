...
import { DataGridPro, GridSlots, isAutogeneratedRow, useGridApiRef } from '@mui/x-data-grid-pro';
...
const AppDataTable: React.FC<any> = (props: {
    ...
    const { appEntorns, salutLastItems, onRowExpansionChange, defaultRowExpansion } = props;
        ...
        <DataGridPro
            ...
            groupingColDef={{
                ...
                renderHeader: (params) => {
                    ...
                    return <Grid container display={'flex'} flexDirection={'row'} alignItems={'center'} justifyContent={'space-between'} width={'100%'}>
                        ...
                        <Grid size={6}>
                            <IconButton onClick={()=> {
                                ...
                                if (defaultRowExpansion!=null) {
                                    Object.keys(defaultRowExpansion).map(id=>{onRowExpansionChange(id, true)})
                                }
                            }}>
                            ...
                            <IconButton onClick={()=> {
                                setExpand(false)
                                if (defaultRowExpansion!=null) {
                                    Object.keys(defaultRowExpansion).map(id=>{onRowExpansionChange(id, false)})
                                }
                            }}>
