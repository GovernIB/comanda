...
export interface IUsuari extends IBaseEntity {
    ...
    autogeneratedEmail: string | undefined;
...
export class UsuariModel extends BaseEntity implements Required<IUsuari> {
    ...
    static readonly AUTOGENERATED_EMAIL: keyof UsuariModel = "autogeneratedEmail";
...
export function isIUsuari(obj: unknown): obj is IUsuari {
    ...
    return (
        ...
        (u.autogeneratedEmail === undefined || typeof u.autogeneratedEmail === 'string') &&
