...
vi.mock('../types/usuari.model.tsx', () => ({
    ...
    UsuariModel: {
        ...
        AUTOGENERATED_EMAIL: 'autogeneratedEmail',
    },
}));
...
describe('UserProfileFormDialog', () => {
    ...
    it('UserProfileFormDialog_quanNoTeEmail_mostraAlertaAmbCorreuAutogenerat', () => {
        // Verifica que si no hi ha email, es mostra l'alerta passant el correu autogenerat.
        const autogeneratedEmail = 'test@autogenerated.com';
        mocks.useFormContextMock.mockReturnValue({
            data: {
                email: undefined,
        ...
        // Comprovem que s'ha cridat t amb les opcions que contenen el correu autogenerat
        expect(mocks.tMock).toHaveBeenCalledWith(expect.any(Function), expect.objectContaining({ autogeneratedEmail }));
    });
});
