package es.caib.comanda.alarmes.persist.config;
...
@EnableJpaRepositories(
		basePackages = { "es.caib.comanda.ms.persist", "es.caib.comanda.alarmes.persist" },
		entityManagerFactoryRef = "mainEntityManager",
		transactionManagerRef = "mainTransactionManager",
		repositoryBaseClass = BaseRepositoryImpl.class
)
public class AlarmaPersistenceConfig extends BasePersistenceConfig {
