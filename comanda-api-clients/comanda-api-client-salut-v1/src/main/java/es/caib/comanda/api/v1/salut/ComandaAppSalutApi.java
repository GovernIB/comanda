...
import es.caib.comanda.service.v1.salut.Pair;
...
public class ComandaAppSalutApi {
  ...
  public SalutInfo salut() throws ApiException {
    ...
    String localVarPath = "/v1/salut".replaceAll("\\{format\\}","json");
  ...
  public AppInfo salutInfo() throws ApiException {
    ...
    // create path and map variables
    String localVarPath = "/v1/salut/info".replaceAll("\\{format\\}","json");
