 ...
 */
@JsonPropertyOrder({
  IntegracioInfo.JSON_PROPERTY_CODI,
  IntegracioInfo.JSON_PROPERTY_NOM
})
...
public class IntegracioInfo {
  ...
  public IntegracioInfo codi(@javax.annotation.Nonnull String codi) {
  ...
  public IntegracioInfo nom(@javax.annotation.Nonnull String nom) {
