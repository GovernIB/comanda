...
|------------- | ------------- | -------------|
| [**getFitxerByNom**](ComandaAppLogsApi.md#getFitxerByNom) | **GET** /v1/logs/{nomFitxer} | Obtenir contingut complet d&#39;un fitxer de log |
| [**llegitUltimesLinies**](ComandaAppLogsApi.md#llegitUltimesLinies) | **GET** /v1/logs/{nomFitxer}/linies/{nLinies} | Obtenir les darreres línies d&#39;un fitxer de log |
| [**llistarFitxers**](ComandaAppLogsApi.md#llistarFitxers) | **GET** /v1/logs | Obtenir el llistat de fitxers de log disponibles |
...
```java
// Import classes:
import es.caib.comanda.service.v1.log.ApiClient;
import es.caib.comanda.service.v1.log.ApiException;
import es.caib.comanda.service.v1.log.Configuration;
import es.caib.comanda.service.v1.log.models.*;
