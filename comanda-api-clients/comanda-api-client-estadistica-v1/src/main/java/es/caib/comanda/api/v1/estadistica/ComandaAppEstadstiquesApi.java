...
import es.caib.comanda.service.v1.estadistica.Pair;
...
public class ComandaAppEstadstiquesApi {
  ...
  public ComandaAppEstadstiquesApi() {
    this(Configuration.getDefaultApiClient());
  }

  public ComandaAppEstadstiquesApi(ApiClient apiClient) {
  ...
  public RegistresEstadistics estadistiques() throws ApiException {
    ...
    String localVarPath = "/v1/estadistiques".replaceAll("\\{format\\}","json");
  ...
  public EstadistiquesInfo estadistiquesInfo() throws ApiException {
    ...
    // create path and map variables
    String localVarPath = "/v1/estadistiques/info".replaceAll("\\{format\\}","json");
  ...
  public RegistresEstadistics estadistiquesPerData(@javax.annotation.Nonnull String data) throws ApiException {
    ...
    // create path and map variables
    String localVarPath = "/v1/estadistiques/of/{data}".replaceAll("\\{format\\}","json")
  ...
  public List<RegistresEstadistics> estadistiquesPerRang(@javax.annotation.Nonnull String dataInici, @javax.annotation.Nonnull String dataFi) throws ApiException {
    ...
    // create path and map variables
    String localVarPath = "/v1/estadistiques/from/{dataInici}/to/{dataFi}".replaceAll("\\{format\\}","json")
