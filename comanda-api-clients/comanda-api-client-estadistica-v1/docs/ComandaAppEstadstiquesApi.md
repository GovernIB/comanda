# ComandaAppEstadstiquesApi

All URIs are relative to *http://localhost*

| Method | HTTP request | Description |
|------------- | ------------- | -------------|
| [**estadistiques**](ComandaAppEstadstiquesApi.md#estadistiques) | **GET** /v1/estadistiques | Obtenir darreres estadístiques diàries disponibles |
| [**estadistiquesInfo**](ComandaAppEstadstiquesApi.md#estadistiquesInfo) | **GET** /v1/estadistiques/info | Obtenir informació de &#39;estructura de les estadístiques |
| [**estadistiquesPerData**](ComandaAppEstadstiquesApi.md#estadistiquesPerData) | **GET** /v1/estadistiques/of/{data} | Obtenir estadístiques d&#39;una data concreta |
| [**estadistiquesPerRang**](ComandaAppEstadstiquesApi.md#estadistiquesPerRang) | **GET** /v1/estadistiques/from/{dataInici}/to/{dataFi} | Obtenir les estadístiques d&#39;un interval donat |
...
```java
// Import classes:
import es.caib.comanda.service.v1.estadistica.ApiClient;
import es.caib.comanda.service.v1.estadistica.ApiException;
import es.caib.comanda.service.v1.estadistica.Configuration;
import es.caib.comanda.service.v1.estadistica.models.*;
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling ComandaAppEstadstiquesApi#estadistiquesInfo");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling ComandaAppEstadstiquesApi#estadistiquesPerData");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling ComandaAppEstadstiquesApi#estadistiquesPerRang");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
